...
export default function HomePage() {
  return <main className="site-shell">
    <nav className="topbar" aria-label="Primary navigation"><a className="wordmark" href="/">Pnyx</a><div className="nav-links"><a href="#principles">Why Pnyx</a><a href="#foundation">Foundation</a></div><a className="nav-action" href="#foundation">Explore the foundation</a></nav>
