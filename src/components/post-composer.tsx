...
export function PostComposer() {
  ...
  const [form, setForm] = useState<ComposerForm>({ spaceSlug: "", type: "DISCUSSION", title: "", body: "", visibility: "PUBLIC" });
  ...
  async function publish(event: FormEvent<HTMLFormElement>) {
    ...
    if (id) window.setTimeout(() => window.location.assign(`/posts/${id}`), 600);
  }
